...
const FRACTIONATION_TOTAL_DOSE: ReactionCategory = {
  ...
  values: [
    ...
    { label: "Bone met / WBRT palliative", value: 30, unit: "Gy" },
...
const DOSE_PER_FRACTION: ReactionCategory = {
  ...
  roles: ["therapist", "oncologist"],
  values: [
    { label: "Conventional fractionation", value: 2.0, unit: "Gy/fx" },
...
const OAR_CONSTRAINTS: ReactionCategory = {
  ...
  values: [
    ...
    { label: "Femoral head max", value: 50, unit: "Gy" },
    { label: "Small bowel max", value: 52, unit: "Gy" },
    { label: "Brainstem max", value: 54, unit: "Gy" },
    { label: "Optic nerve/chiasm max", value: 55, unit: "Gy" },
...
const TUMOR_STAGING: ReactionCategory = {
  ...
  values: [
    ...
    { label: "T1b lung / T1 breast max", value: 2, unit: "cm" },
    { label: "T1c lung", value: 3, unit: "cm" },
    { label: "T2a lung", value: 4, unit: "cm" },
    { label: "T2 breast / T2b lung", value: 5, unit: "cm" },
...
const QA_TOLERANCES: ReactionCategory = {
  ...
  values: [
    { label: "SRS localization accuracy", value: 0.5, unit: "mm" },
    ...
    { label: "Jaw position accuracy", value: 2, unit: "mm" },
    { label: "Couch position accuracy", value: 3, unit: "mm" },
  ],
};
...
const CALIBRATION_REF: ReactionCategory = {
  ...
  values: [
    ...
    { label: "kQ farmer chamber 18 MV", value: 0.963, unit: "" },
  ],
};
...
const TISSUE_DENSITIES: ReactionCategory = {
  ...
  values: [
    ...
    { label: "Muscle density", value: 1.06, unit: "g/cm³" },
