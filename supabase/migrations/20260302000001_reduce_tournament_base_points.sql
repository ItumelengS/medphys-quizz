-- Reduce base points per correct answer from 100 to 50
-- This makes time bonus matter more relative to correctness:
--   4/4 correct, 0s remaining = 200 pts (was 400)
--   4/4 correct, 10s remaining = 200 + 400 = 600 pts (was 800)
-- Speed now makes a ~3x difference instead of barely mattering.
